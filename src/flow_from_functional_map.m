function [pairvx, pairvy, validpoints] = flow_from_functional_map(All_func_maps, All_eig_vecs, xsize, ysize)
% =========================================================
...
for i = 1:num_images
    for j = 1:num_images
        ...
        [vx, vy, valid_points] = pairwise_flow(funcmap, basis1, basis2, xsize, ysize);
        pairvx{i,j} = vx;
        pairvy{i,j} = vy;
        validpoints{i,j} = valid_points;
        fprintf('computed flow %d %d \n', i ,j);
    end
end
end

function [vx, vy, valid_points] = pairwise_flow(funcmap, basis1, basis2, xsize, ysize)
