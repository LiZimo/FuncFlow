    ...
    for z_flip = 1:flip
        ...
        for y = 1:num_images
            ...
            for y_flip = 1:flip
                ...
                img1_projected_indicators = [indicator_constraints_1    latent_constraint*basis_constraints1];
                img2_projected_indicators = [indicator_constraints_2    latent_constraint*basis_constraints2];
